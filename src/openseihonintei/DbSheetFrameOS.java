...
//        split = new javax.swing.JSplitPane[maxCols];
        ...
        for (int i = 0; i < maxCols; i++) {
            editPre[i] = new openseiho.OsText("");
            edit[i] = new openseiho.OsText("");
...
@SuppressWarnings("empty-statement")
    ...
    private void initComponents() {
        ...
        jTextFieldTableName = new openseiho.OsText();
        jLabel2 = new javax.swing.JLabel();
        jTextFieldWhere = new openseiho.OsText();
...
//        setTitle(org.openide.util.NbBundle.getMessage(DbSheetFrameOS.class, "dbSheetFrame.title_1")); // NOI18N
    ...
    private openseiho.OsText jTextFieldTableName;
    private openseiho.OsText jTextFieldWhere;
